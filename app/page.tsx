...
export default function Home() {
  return (
    <div className="flex flex-col items-center min-h-screen">
      ...
      <div className="flex justify-evenly items-center align-center w-full mb-8">
        ...
        <div>
          <div className="bg-gray-200 h-9 rounded-3xl flex items-center justify-center text-gray-500 p-3">
            <p>Location</p>
